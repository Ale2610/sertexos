...
sertexosapi = http.get("https://raw.githubusercontent.com/Sertex-Team/sertexos/master/sertexos.lua")
sertextextapi = http.get("https://raw.githubusercontent.com/Sertex-Team/sertexos/master/sertextext.lua")
...
f.close()
print("Downloaded .seretxos/apps")
...
f = fs.open(Root .. "firewolf", "w")
f.write(firewolf.readAll())
f.close()
print("Downloaded .sertexos/firewolf")
